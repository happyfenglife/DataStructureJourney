...
public:
  ...
  void dfs(const vector<vector<int>> &graph, int seats, int u, int p, vector<int> &sz, vector<long long> &cost)
  {
    sz[u] = 1;
    for (int v : graph[u])
    {
